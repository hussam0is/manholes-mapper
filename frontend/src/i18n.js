...
export const i18n = {
  he: {
    ...
    importLegacySketch: 'יבוא שרטוט ישן + קואורדינטות',
    ...
    offline: {
      wentOffline: 'עובד במצב לא מקוון — השינויים יסונכרנו כשהחיבור יחזור',
      backOnline: 'החיבור חזר — כל השינויים סונכרנו',
      backOnlinePending: (count) => `החיבור חזר — מסנכרן ${count} שינויים ממתינים`,
    },
    nodeTypeLabel: { manhole: 'שוחה', home: 'חיבור בית', drainage: 'קולטן', covered: 'שוחה מכוסה', issue: 'בעיה', forlater: 'להמשך טיפול' },
    edgeLabel: 'קו',
    detailsDefault: 'בחר שוחה או קו כדי לערוך.',
    detailsConnectedLinesError: 'שגיאה בטעינת הקווים המחוברים — בחר את השוחה מחדש',
    ...
    toasts: {
      ...
      rtkFixedLocked: 'שוחה עם מדידת RTK Fixed — לא ניתן להזיז ידנית',
      edgeChainCancel: 'סיים שרשור',
      chainEnded: 'השרשור הסתיים',
      longPressEdge: 'גרור לצומת כדי ליצור קו',
      allNodesComplete: 'כל הצמתים מלאים!',
      nodeSelected: (id) => `נבחר צומת ${id}`,
      edgeSelected: (tail, head) => `נבחר קו ${tail} → ${head}`,
      zoom: (p) => `זום: ${p}%`,
      ...
      importingLegacy: 'מייבא שרטוט ישן...',
      legacySketchImported: 'שרטוט ישן יובא בהצלחה',
      ...
      sketchReadOnly: 'השרטוט נעול לצפייה בלבד — אין אפשרות לערוך',
    ...
    confirms: {
      ...
      deleteNode: 'למחוק שוחה זו?',
      deleteNodeDetailed: 'למחוק שוחה {id}? המידע הבא יאבד:',
      dataNote: 'הערה',
      dataSurvey: 'קואורדינטות מדידה',
      dataMaintenance: 'סטטוס תחזוקה',
      dataMaterial: 'חומר',
      dataCover: 'פרטי מכסה',
      dataEdges: 'קווים מחוברים',
...
התא השכן יוסר והחיבורים שלו יועברו לשרטוט הפעיל.`,
    ...
    alerts: {
      ...
      legacyImportFailed: 'שגיאה ביבוא שרטוט ישן',
    ...
    labels: {
      ...
      dataComplete: 'כל הנתונים הנדרשים מלאים',
      dataCompleteness: 'שלמות נתונים',
      connectionFlow: 'כיוון זרימה',
      deleteNode: 'מחק שוחה',
      fromNode: 'משוחה',
      toNode: 'לשוחה',
      edgeType: 'סוג קו',
      ...
      deleteEdge: 'מחק קו',
      confirmDeleteNode: 'לחץ שוב למחיקת שוחה',
      confirmDeleteEdge: 'לחץ שוב למחיקת קו',
      edgeSectionClassification: 'סיווג',
      edgeSectionPhysical: 'מאפיינים פיזיים',
      edgeSectionMeasurements: 'מדידות',
    ...
    adminPanel: {
      ...
      fixes: {
        ...
        types: {
          ...
          obstructed_access: 'גישה חסומה',
          schematic_location: 'מיקום סכמטי',
          missing_tl: 'חסר רום מכסה',
        },
      },
    },
    projects: {
      ...
      targetKm: 'יעד ק"מ',
      targetKmPlaceholder: 'סה"כ ק"מ צפוי (לדוגמה: 200)',
      targetKmLabel: 'יעד',
    ...
    fixes: {
      ...
      scheduleRevisit: 'תזמן ביקור חוזר',
      measureCoordinates: 'מדוד קואורדינטות',
      measureTL: 'מדוד רום מכסה',
      fillMaterial: 'מלא חומר מכסה',
      markSchematic: 'סמן כסכמטי',
      applied: 'תיקון יושם',
      prevIssue: 'בעיה קודמת',
      nextIssue: 'בעיה הבאה',
      issueCounter: (current, total) => `${current} מתוך ${total}`,
    ...
    projectStats: {
      ...
      issues: 'בעיות',
      perSketch: 'לפי שרטוט',
      nodeTypes: 'התפלגות סוגי צמתים',
      accuracyDist: 'התפלגות דיוק',
      perSurveyor: 'לפי מודד',
      surveyor: 'מודד',
      nodesMeasured: 'צמתים שנמדדו',
      avgAccuracy: 'דיוק ממוצע',
      stars: 'כוכבים',
      issueSummary: 'סיכום בעיות',
      missingCoords: 'חסרות קואורדינטות',
      missingMeasurements: 'חסרים מדידות',
      longEdges: 'קווים ארוכים (>70 מ\')',
      negativeGradients: 'שיפועים שליליים',
    },
    metadata: {
      title: 'מטא-נתונים וסטטיסטיקה',
      refresh: 'רענן',
      overview: 'סקירה כללית',
      dbHealth: 'בריאות מסד נתונים',
      ...
      totalEdges: 'סה"כ קווים',
      growthSketches: 'מגמת שרטוטים (12 חודשים)',
      growthNodes: 'מגמת צמתים (12 חודשים)',
      orgBreakdown: 'פירוט לפי ארגון',
      organization: 'ארגון',
      userActivity: 'פעילות משתמשים',
      user: 'משתמש',
      role: 'תפקיד',
      lastActive: 'פעילות אחרונה',
      storageMetrics: 'מדדי אחסון',
      avgNodesPerSketch: 'צמתים ממוצע/שרטוט',
      avgEdgesPerSketch: 'קווים ממוצע/שרטוט',
      largestSketches: 'שרטוטים גדולים ביותר',
      name: 'שם',
      featureAdoption: 'אימוץ תכונות',
      engagement: 'מעורבות משתמשים',
      activeSessions: 'סשנים פעילים',
      dataQuality: 'איכות נתונים',
      coordCoverage: 'כיסוי קואורדינטות',
      withCoords: 'עם קואורדינטות',
      withoutCoords: 'ללא קואורדינטות',
      withMeasurements: 'עם מדידות',
      withMaterial: 'עם חומר',
      issueNodes: 'צמתי בעיה',
      sketchSizes: 'התפלגות גדלי שרטוט',
      sketchSizesDesc: 'מספר צמתים לכל שרטוט',
      orphanedData: 'נתונים יתומים',
      sketchesNoProject: 'שרטוטים ללא פרויקט',
      usersNoOrg: 'משתמשים ללא ארגון',
      activeLocks: 'נעילות פעילות',
      noActiveLocks: 'אין נעילות פעילות',
      sketch: 'שרטוט',
      lockedBy: 'ננעל ע"י',
      expiresAt: 'תפוגה',
      tableCounts: 'ספירת טבלאות',
      table: 'טבלה',
      rows: 'שורות',
    },
    statistics: {
      ...
      velocity: 'קצב שבועי',
      velocityTrend: 'מגמת קצב (12 שבועות)',
      nodesPerWeek: 'שוחות/שבוע',
      forecast: 'תחזית',
      forecastDays: 'סיום משוער בעוד {0} ימים',
      forecastDate: 'יעד: {0}',
      noForecast: 'אין מספיק נתונים',
      completionForecast: 'תחזית השלמה',
      periodComparison: 'לעומת שבוע שעבר',
      accuracyDistribution: 'התפלגות דיוק',
      rtk: 'RTK Fixed',
      rtkFloat: 'RTK Float',
      dgps: 'DGPS',
      gpsOnly: 'GPS',
      ...
      missingCoords: 'חסרות קואורדינטות',
      missingMeasurements: 'חסרות מדידות',
      longEdges: 'קווים ארוכים (>70 מ׳)',
      negativeGradients: 'שיפועים שליליים',
      noIssues: 'לא נמצאו בעיות',
      activityHeatmap: 'פעילות צוות (90 יום)',
      nodesPerDay: 'שוחות/יום',
      ...
      atRisk: 'בסיכון',
      critical: 'קריטי',
      velocityUp: 'עלייה של {0}%',
      velocityDown: 'ירידה של {0}%',
      velocityFlat: 'קצב יציב',
    ...
    fc: {
      ...
      syncStatus: 'סנכרון',
      synced: 'מסונכרן',
      pendingCount: (count) => `${count} ממתינים`,
      syncing: 'מסנכרן...',
      offline: 'לא מקוון',
      syncError: 'שגיאת סנכרון',
      achievement: {
  ...
  en: {
    ...
    modeHome: 'Add House Connection',
    modeDrainage: 'Add Drainage',
    modeForLater: 'For Later',
    modeIssue: 'Issue',
    modeEdge: 'Draw Pipe (E)',
    modeNodeType: 'Choose node type',
    home: 'Home',
    drainage: 'Drainage',
    forLater: 'For Later',
    ...
    importLegacySketch: 'Import Legacy Sketch + Coordinates',
    ...
    offline: {
      wentOffline: 'Working offline — changes will sync when connected',
      backOnline: 'Back online — all changes synced',
      backOnlinePending: (count) => `Back online — syncing ${count} pending changes`,
    },
    nodeTypeLabel: { manhole: 'Manhole', home: 'Home', drainage: 'Drainage', covered: 'Covered', issue: 'Issue', forlater: 'For Later' },
    edgeLabel: 'Edge',
    detailsDefault: 'Select a node or edge to edit.',
    detailsConnectedLinesError: 'Connected lines failed to load — reselect the node',
    ...
    toasts: {
      ...
      rtkFixedLocked: 'RTK Fixed manhole — position cannot be moved manually',
      edgeChainCancel: 'End chain',
      chainEnded: 'Chain ended',
      longPressEdge: 'Drag to node to create edge',
      allNodesComplete: 'All nodes are complete!',
      nodeSelected: (id) => `Node ${id} selected`,
      edgeSelected: (tail, head) => `Edge ${tail} → ${head} selected`,
      zoom: (p) => `Zoom: ${p}%`,
      ...
      importingLegacy: 'Importing legacy sketch...',
      legacySketchImported: 'Legacy sketch imported successfully',
      ...
      sketchReadOnly: 'Sketch is locked — read only',
    ...
    confirms: {
      ...
      deleteNodeDetailed: 'Delete node {id}? The following data will be lost:',
      dataNote: 'Note',
      dataSurvey: 'Survey coordinates',
      dataMaintenance: 'Maintenance status',
      dataMaterial: 'Material',
      dataCover: 'Cover info',
      dataEdges: 'Connected edges',
    ...
    alerts: {
      ...
      legacyImportFailed: 'Error importing legacy sketch',
    ...
    labels: {
      ...
      dataComplete: 'All required data is complete',
      ...
      confirmDeleteNode: 'Tap again to delete node',
      confirmDeleteEdge: 'Tap again to delete edge',
      edgeSectionClassification: 'Classification',
      edgeSectionPhysical: 'Physical Properties',
      edgeSectionMeasurements: 'Measurements',
    ...
    adminPanel: {
      ...
      fixes: {
        ...
        types: {
          ...
          obstructed_access: 'Obstructed Access',
          schematic_location: 'Schematic Location',
          missing_tl: 'Missing TL Elevation',
        },
      },
    },
    projects: {
      ...
      targetKm: 'Target km',
      targetKmPlaceholder: 'Total expected km (e.g. 200)',
      targetKmLabel: 'Target',
    ...
    fixes: {
      ...
      scheduleRevisit: 'Schedule Revisit',
      measureCoordinates: 'Measure Coordinates',
      measureTL: 'Measure TL Elevation',
      fillMaterial: 'Fill Cover Material',
      markSchematic: 'Mark as Schematic',
      applied: 'Fix applied',
      prevIssue: 'Previous issue',
      nextIssue: 'Next issue',
      issueCounter: (current, total) => `${current} of ${total}`,
    ...
    projectStats: {
      ...
      nodeTypes: 'Node Type Distribution',
      accuracyDist: 'Accuracy Distribution',
      perSurveyor: 'Per Surveyor',
      surveyor: 'Surveyor',
      ...
      longEdges: 'Long Edges (>70m)',
      negativeGradients: 'Negative Gradients',
    },
    metadata: {
      ...
      totalNodes: 'Total Nodes',
      totalEdges: 'Total Edges',
      growthSketches: 'Sketch Growth (12 months)',
      growthNodes: 'Node Growth (12 months)',
      orgBreakdown: 'Organization Breakdown',
      ...
      avgNodesPerSketch: 'Avg Nodes/Sketch',
      avgEdgesPerSketch: 'Avg Edges/Sketch',
      largestSketches: 'Largest Sketches',
      name: 'Name',
      featureAdoption: 'Feature Adoption',
      engagement: 'User Engagement',
      activeSessions: 'Active Sessions',
      dataQuality: 'Data Quality',
      coordCoverage: 'Coordinate Coverage',
      withCoords: 'With Coordinates',
      withoutCoords: 'Without Coordinates',
      withMeasurements: 'With Measurements',
      withMaterial: 'With Material',
      issueNodes: 'Issue Nodes',
      sketchSizes: 'Sketch Size Distribution',
      sketchSizesDesc: 'Number of nodes per sketch',
      orphanedData: 'Orphaned Data',
      sketchesNoProject: 'Sketches without Project',
      usersNoOrg: 'Users without Org',
    ...
    statistics: {
      ...
      velocityTrend: 'Velocity Trend (12 weeks)',
      nodesPerWeek: 'nodes/week',
      forecast: 'Forecast',
      forecastDays: 'Est. completion in {0} days',
      forecastDate: 'Target: {0}',
      noForecast: 'Insufficient data',
      ...
      negativeGradients: 'Negative Gradients',
      noIssues: 'No issues found',
      activityHeatmap: 'Team Activity (90 days)',
      nodesPerDay: 'Nodes/Day',
      ...
      atRisk: 'At Risk',
      critical: 'Critical',
      velocityUp: 'Velocity up {0}%',
      velocityDown: 'Velocity down {0}%',
      velocityFlat: 'Velocity stable',
      totalIssues: 'Total Issues',
      less: 'Less',
      more: 'More',
      kmPerWeek: 'km/week',
