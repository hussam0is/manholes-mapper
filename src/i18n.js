...
export const i18n = {
  he: {
    ...
    toasts: {
      ...
      edgeEndpointDetached: 'הקצה נותק - גרור לשוחה אחרת או שחרר',
      edgeEndpointReattached: 'הקצה חובר לשוחה',
      undoEdgeDetach: 'ניתוק הקצה בוטל',
      undoEdgeReattach: 'העברת הקצה בוטלה',
...
התא השכן יוסר והחיבורים שלו יועברו לשרטוט הפעיל.`,
  ...
  en: {
    ...
    toasts: {
      ...
      edgeEndpointDetached: 'Endpoint detached - drag to another node or release',
      edgeEndpointReattached: 'Endpoint connected to node',
      undoEdgeDetach: 'Endpoint detach undone',
      undoEdgeReattach: 'Endpoint move undone',
