...
export const i18n = {
  he: {
    ...
    labels: {
      ...
      deleteEdge: 'מחק קו',
      confirmDeleteNode: 'אישור מחיקה?',
      confirmDeleteEdge: 'אישור מחיקה?',
      sectionProperties: 'מאפיינים',
      sectionFallGrade: 'מפל/שיפוע',
      sectionMeasurements: 'מדידות',
      sectionConnectedLines: 'קווים מחוברים',
      manhole: 'שוחה',
      line: 'קו',
      homeConnection: 'חיבור בית',
      drainage: 'ניקוז',
    },
    admin: {
      manage: 'ניהול',
  ...
  en: {
    ...
    labels: {
      ...
      confirmDeleteNode: 'Confirm delete?',
      confirmDeleteEdge: 'Confirm delete?',
      sectionProperties: 'Properties',
      sectionFallGrade: 'Fall / Grade',
      sectionMeasurements: 'Measurements',
      sectionConnectedLines: 'Connected lines',
      manhole: 'Manhole',
      line: 'Line',
