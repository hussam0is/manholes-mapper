...
התא השכן יוסר והחיבורים שלו יועברו לשרטוט הפעיל.`,
    ...
    nodeIssues: {
      ...
      descriptionPlaceholder: 'תאר את התקלה...',
      submitIssue: 'שלח תקלה',
      cancelIssue: 'ביטול',
      status: 'סטטוס',
      statusOpen: 'פתוח',
      statusFixSubmitted: 'תיקון הוגש',
      statusResolved: 'טופל',
      createdBy: 'נוצר ע"י',
      createdAt: 'נוצר בתאריך',
      fixButton: 'תוקן',
      fixDescription: 'תיאור התיקון',
      fixPlaceholder: 'תאר מה תיקנת...',
      submitFix: 'שלח תיקון',
      cancelFix: 'ביטול',
      fixSubmittedBy: 'תיקון ע"י',
      fixSubmittedAt: 'הוגש בתאריך',
      reviewFixes: 'סקירת תיקונים',
      confirmFix: 'אשר תיקון',
      rejectFix: 'דחה תיקון',
      fixConfirmed: 'התיקון אושר',
      fixRejected: 'התיקון נדחה',
      issueAdded: 'תקלה נוספה',
      fixSubmitted: 'תיקון הוגש בהצלחה',
      noIssues: 'אין תקלות',
      issueListTitle: 'רשימת תקלות',
      sortByLocation: 'מיון לפי מיקום',
      sortByNode: 'מיון לפי שוחה',
      openIssueCount: (count) => `${count} תקלות פתוחות`,
      pendingReviewCount: (count) => `${count} ממתינות לאישור`,
      removeIssue: 'הסר תקלה',
      issueRemoved: 'תקלה הוסרה',
    },
  },
  en: {
    ...
    nodeIssues: {
      ...
      status: 'Status',
      statusOpen: 'Open',
      statusFixSubmitted: 'Fix Submitted',
      statusResolved: 'Resolved',
      createdBy: 'Created by',
      createdAt: 'Created at',
      fixButton: 'Fixed',
      fixDescription: 'Fix Description',
      fixPlaceholder: 'Describe what you fixed...',
      submitFix: 'Submit Fix',
      cancelFix: 'Cancel',
      fixSubmittedBy: 'Fix by',
      fixSubmittedAt: 'Submitted at',
      ...
      fixSubmitted: 'Fix submitted successfully',
      noIssues: 'No issues',
      issueListTitle: 'Issue List',
      sortByLocation: 'Sort by location',
      sortByNode: 'Sort by node',
      openIssueCount: (count) => `${count} open issues`,
      pendingReviewCount: (count) => `${count} pending review`,
