...
export const i18n = {
  he: {
    ...
    toasts: {
      ...
      finishWorkDayComplete: 'יום עבודה הסתיים בהצלחה!',
      finishWorkDayFailed: 'שגיאה בסיום יום עבודה',
      finishWorkDayProcessing: 'מעבד סיום יום עבודה...',
    },
    renamed: 'שם עודכן',
    finishWorkDay: 'סיום יום עבודה',
    orphanEdgesFound: 'נמצאו קווים עם שוחות חסרות',
    selectNodeType: 'יש לבחור סוג לכל שוחה חסרה כדי להמשיך:',
    confirmAndContinue: 'אשר והמשך',
    forLater: 'להמשך',
    unknown: 'לא ידוע',
    confirms: {
  ...
  en: {
    ...
    toasts: {
      ...
      finishWorkDayComplete: 'Work day finished successfully!',
      finishWorkDayFailed: 'Error finishing work day',
      finishWorkDayProcessing: 'Processing finish work day...',
    },
    renamed: 'Renamed',
    finishWorkDay: 'Finish Work Day',
    orphanEdgesFound: 'Found edges with missing nodes',
    selectNodeType: 'Please select a type for each missing node to continue:',
